...
function make_note_link(t) { return `<div class="item"><a class="del">⨷</a> <a class="note" onclick="anote = (anote === ${t})? '' : ${t}; byId('editor').value = '${get_note(t)}'; redraw();">${get_note(t)}</a></div>`; }
